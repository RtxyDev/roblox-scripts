...
function OrionLib:CreateRoFluxPage(Menu)
    ...
    local CurrentDiscord = game:HttpGetAsync("https://roflux.net/currentdiscord.txt")

    local DiscordSection = RoFluxTab:AddSection({
        Name = "Discord Info"
    })

    local CreditSection = RoFluxTab:AddSection({
        Name = "Credits"
    })

    OrionLib:MakeNotification({
        Name = "IMPORTANT!",
        Content = "NEW ROFLUX DISCORD SERVER PLEASE JOIN",
    ...
    DiscordSection:AddButton({
        Name = "Join Ro-Flux Discord Server",
        Callback = function()
    ...
    DiscordSection:AddParagraph("Discord Servers","Join at https://roflux.net/discord or\n discord.gg/"..tostring(CurrentDiscord))


    
    
    CreditSection:AddLabel("Created by Ro-Flux")
